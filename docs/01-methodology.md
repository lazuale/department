...
[Главная](../README.md) · **01 Модель** · [02 Сценарии](02-scripts.md) · [03 Контроль и улучшение](03-control.md) · [04 Шаблоны](04-templates.md) · [05 OpenProject](05-openproject.md) · [06 Процессы](06-processes.md)

---

Этот файл описывает базовую модель организации обязательной работы: единицу работы, роли, состояния, сроки, приоритеты и границы решений. Остальные разделы показывают её применение.
...
| Исполнитель | выполняет работу и ведёт её состояние | рабочие переходы состояний в пределах модели |
...
Идея должна быть связана с наблюдаемой проблемой, потерей или возможностью улучшения. После реализации эффект проверяется по данным процесса.
...
Они определяются при внедрении и не должны противоречить базовой модели управления.
