...
Task Property[Контрагент]   → res.partner
```
...
## 10. Assignee и предметный Employee — разные связи
...
Property[Сотрудник]
= сотрудник, которого касается работа
```

Эти значения могут совпадать, но методически отвечают на разные вопросы.
